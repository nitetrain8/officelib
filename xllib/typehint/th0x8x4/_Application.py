...
_Application_vtables_ = [
	...
	(( 'Assistant' , 'prop' , ), 15, (15, (), [ (16393, 10, None, "IID('{000C0322-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 100 , (3, 0, None, None) , 0 , )),
	...
	(( 'MountVolume' , 'Zone' , 'Server' , 'Volume' , 'User' , 
			 ...
			 (16386, 10, None, None) , ], 1 , 1 , 4 , 3 , 612 , (3, 0, None, None) , 0 , )),
	...
	(( 'AnswerWizard' , 'prop' , ), 409, (409, (), [ (16393, 10, None, "IID('{000C0360-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 760 , (3, 0, None, None) , 0 , )),
	...
	(( 'SmartTagRecognizers' , 'prop' , ), 460, (460, (), [ (16393, 10, None, "IID('{F2B60A10-DED5-46FB-A914-3C6F4EBB6451}')") , ], 1 , 2 , 4 , 0 , 844 , (3, 0, None, None) , 0 , )),
	(( 'SmartTagTypes' , 'prop' , ), 461, (461, (), [ (16393, 10, None, "IID('{DB8E3072-E106-4453-8E7C-53056F1D30DC}')") , ], 1 , 2 , 4 , 0 , 848 , (3, 0, None, None) , 0 , )),
